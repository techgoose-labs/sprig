...
| [migrating-1x-to-2x.md](./migrating-1x-to-2x.md) | **on `@mrg-keystone/sprig@1.x`?** getting the 2.x CLI, what one `sprig build` migrates for you, the `serve.ts` / `/api/docs` / wire-path steps you do by hand                                      |
